...
impl Gpu for PsxGpu {
    ...
    /// This function is used to submit GP1 commands.
    fn submit_to_gp1(&mut self, bridge: &mut dyn GpuBridge, word: u32) {
        ...
        // Switch endianness.
        let word = word.swap_endianness();

        // Submit to correct method.
        match word >> 24 {

            0 | 0x40 | 0x80 | 0xC0 => self.gp1_00(),

            0x1 | 0x41 | 0x81 | 0xC1 => self.gp1_01(),

            0x2 | 0x42 | 0x82 | 0xC2 => self.gp1_02(),

            0x3 | 0x43 | 0x83 | 0xC3 => self.gp1_03(word),

            0x4 | 0x44 | 0x84 | 0xC4 => self.gp1_04(word),

            0x5 | 0x45 | 0x85 | 0xC5 => self.gp1_05(word),

            0x6 | 0x46 | 0x86 | 0xC6 => self.gp1_06(word),

            0x7 | 0x47 | 0x87 | 0xC7 => self.gp1_07(word),

            0x8 | 0x48 | 0x88 | 0xC8 => self.gp1_08(word),

            0x9 | 0x49 | 0x89 | 0xC9 => self.gp1_09(word),

            0x10 | 0x11 | 0x12 | 0x13 | 0x14 | 0x15 |
            0x16 | 0x17 | 0x18 | 0x19 | 0x1A | 0x1B |
            0x1C | 0x1D | 0x1E | 0x1F | 0x50 | 0x51 |
            0x52 | 0x53 | 0x54 | 0x55 | 0x56 | 0x57 |
            0x58 | 0x59 | 0x5A | 0x5B | 0x5C | 0x5D |
            0x5E | 0x5F | 0x90 | 0x91 | 0x92 | 0x93 |
            0x94 | 0x95 | 0x96 | 0x97 | 0x98 | 0x99 |
            0x9A | 0x9B | 0x9C | 0x9D | 0x9E | 0x9F |
            0xD0 | 0xD1 | 0xD2 | 0xD3 | 0xD4 | 0xD5 |
            0xD6 | 0xD7 | 0xD8 | 0xD9 | 0xDA | 0xDB |
            0xDC | 0xDD | 0xDE | 0xDF => self.gp1_10(word),
