...
impl CP2 {
    ...
    pub fn gte_function(&mut self, opcode: i32) -> i32 {
        ...
        match opcode & 0x3F {
            ...
            0x1B => {
                self.handle_common_ncc(opcode, InstructionVariant::Single);
                17
            },
            ...
            0x3F => {
                self.handle_common_ncc(opcode, InstructionVariant::Triple);
                39
            },
    ...
    fn handle_unsaturated_result_and_truncate(&mut self, result: i64, result_type: UnsaturatedFlagRegisterField) -> i64 {
        ...
        let (lower_bound, upper_bound) = match result_type {
            ...
            // Again, this corrects a misconception for the larger bound in the original version.
