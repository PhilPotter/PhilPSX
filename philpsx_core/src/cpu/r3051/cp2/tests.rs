...
#[test]
fn nct_should_produce_correct_result() {
    ...
    cp2.handle_common_nc(0x4BE80020, InstructionVariant::Triple);
...
#[test]
fn avsz4_should_produce_correct_result() {

    let mut cp2 = CP2::new();

    // Setup ZFS4.
    cp2.write_control_reg(30, 0x272E, false);

    // Setup SZ1, SZ2 and SZ3.
    cp2.write_data_reg(16, 0xD695, false);
    cp2.write_data_reg(17, 0xFBA2, false);
    cp2.write_data_reg(18, 0x7C3A, false);
    cp2.write_data_reg(19, 0xA213, false);

    // Execute AVSZ4.
    cp2.handle_avsz4(0x4BE0002E);
...
#[test]
fn gpl_should_produce_correct_result() {

    let mut cp2 = CP2::new();

    // Setup IR0, IR1, IR2 and IR3.
    cp2.write_data_reg(8, 0x7F75, false);
    cp2.write_data_reg(9, 0xC9FE, false);
    cp2.write_data_reg(10, 0x5FFC, false);
    ...
    // Execute GPL (with sf bit set to 1 and lm bit set to 0).
    cp2.handle_gpl(0x4BE8003E);
